...
class ShopDAO:
    ...
    def _seed_default_shop_data(self, conn: sqlite3.Connection) -> None:
        ...
        cur = conn.cursor()
        products = [
            ("폴로 랄프로렌 클래식 핏 샴브레이 셔츠", "상의", 219000, 239000, 12, "인디고 스톤 워싱 처리된 빈티지 코튼 소재, 여유로운 클래식 핏과 가슴의 멀티 컬러 시그니처 포니 자수 (스타일 번호: 279038)", "/store/images/ralph_lauren_chambray.jpg", 4.9, 148, "랄프로렌,폴로,셔츠,샴브레이,클래식핏,상의,인디고,데님셔츠,코튼,남성셔츠,279038"),
